...
export function ContactServices() {
  ...
  const whatsappLink = buildWhatsAppInquiryUrl({
    sourcePage: "Services Contact Section",
  ...
  const briefWhatsappLink = useMemo(
    () =>
      buildWhatsAppInquiryUrl({
        sourcePage: "Services Contact Section - Brief Form",
        name: briefForm.name,
        ...
        <div className="grid grid-cols-1 gap-10 lg:grid-cols-[minmax(0,1fr)_minmax(520px,0.96fr)] lg:items-start lg:gap-14">
          <Reveal y={18} duration={0.42}>
            <div className="max-w-[41rem] pt-2">
              ...
              <div className="mt-14 border border-[rgba(255,255,255,0.72)] bg-[rgba(6,22,32,0.34)] px-7 py-8 sm:px-10 sm:py-10">
                ...
                <p className="mt-8 max-w-[31ch] font-body text-[clamp(1rem,1.05vw,1.16rem)] font-light leading-[1.55] text-white">
                  ...
                  your need is urgent, type &quot;URGENT&quot; at the beginning
                  of the message.
                </p>
              </div>
            </div>
          ...
          <Reveal y={18} delay={0.06} duration={0.42}>
            ...
            >
              ...
              <div className="mt-10 space-y-4">
                ...
                <input
                  type="text"
                  placeholder="Project Type (e.g. Website, System, AI)"
              ...
              >
                ...
                <span
                  aria-hidden="true"
                  className="ml-4 text-[1.8rem] text-[#2B7BC1]"
                >
                  →
                </span>
              </a>
